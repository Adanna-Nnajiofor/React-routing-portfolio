...
const Blog = () => {
  ...
  return (
    <section
      id="blog"
      className="bg-gray-200 py-12 text-black flex flex-col p-6 w-full h-full items-center lg:flex-row    lg:items-start"
    >
      <div className="p-6 w-full flex flex-col lg:sticky top-0 bottom-0">
        ...
        <p className=" text-xl leading-9 ">
          ...
          architecture, web development, design trends, and much more. Our goal
          is to provide valuable content that inspires, educates, and informs
          our readers. Whether you're a seasoned professional looking for
          industry updates or a newcomer eager to learn, our blog has something
          for everyone. Explore our latest posts below and join us on a journey
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {blogPosts.map((post, index) => (
          <div
            key={index}
            className="bg-purple-200 p-6 rounded-lg shadow-md mb-6"
          >
