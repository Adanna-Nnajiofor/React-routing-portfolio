...
import web from "../assets/images/woman-codes.jpg";
  ...
  return (
    <section className="bg-purple-100 p-6 text-black flex flex-col w-full h-full items-center lg:items-start">
      ...
      <div className="flex flex-col lg:flex-row">
        {/* About Section */}
        <div className="w-full  bg-gray-100 p-8 mt-12 shadow-lg lg:mr-3">
        ...
        {/* Services Overview */}
        <div className="w-full bg-gray-100 p-8 mt-12 shadow-lg lg:ml-3">
