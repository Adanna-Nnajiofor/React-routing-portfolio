    ...
    <section className="bg-gray-200 text-black flex flex-col p-6 w-full h-full items-center lg:flex-row lg:items-start">
      <div className="p-6 w-full flex flex-col lg:sticky top-0 bottom-0">
        ...
        <p className="text-xl mb-8 leading-9">
          We look forward to connecting with you and exploring how we can bring
          your ideas to life. Whether you have a project in mind, need more
          information about our services, or just want to say hello, don't
